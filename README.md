...
- SBC-RT- Code for the application's Lambda function.
...
The SAM CLI installs dependencies defined in `SBC-RT/requirements.txt`, creates a deployment package, and saves it in the `.aws-sam/build` folder.
...
```bash
SBC-RT$ sam local invoke SBCRTFunction --event events/event.json
```
